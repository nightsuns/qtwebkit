...
if (USE_MINIMAL_DEBUG_INFO AND CMAKE_BUILD_TYPE STREQUAL "Debug")
    target_compile_options(WTF                PRIVATE -g -O0)
    target_compile_options(JavaScriptCore     PRIVATE -g -O0)
    target_compile_options(WebCore            PRIVATE -g -O0)
    target_compile_options(WebCoreTestSupport PRIVATE -g -O0)
    if (TARGET ANGLESupport)
        target_compile_options(ANGLESupport   PRIVATE -g -O0)
    endif ()
    if (TARGET gtest)
        target_compile_options(gtest          PRIVATE -g -O0)
    endif ()

    target_compile_options(WebKit            PRIVATE -g -O0)
    target_compile_options(WebKit2           PRIVATE -g -O0)
